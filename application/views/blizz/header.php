...
<div id="toppanel">
	...
	<script type="text/javascript">
		...
		var attributes = {};
		swfobject.embedSWF("<?php echo BASE_PATH;?>/public/templates/<?php echo TEMPLATE; ?>/_flash/frontpage/en-gb/banner-wrath.swf", "flashHeader", "100%", "500", "9.0.0", false, flashvars, params, attributes);
	</script>
