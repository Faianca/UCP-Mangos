...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <?php echo $html->includeJs('slide');?>
     <link rel="stylesheet" type="text/css" media="screen, projection" href="./Blizzard Entertainment_files/safari.css">    
...
//]]>
	...
	<body class="company-landing" hkid="[object HTMLBodyElement]">
