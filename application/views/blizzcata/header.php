...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <?php echo $html->includeCss('safari');?>
        ...
        <?php echo $html->includeJs('slider'); ?>
...
<div id="toppanel">
	...
	<style type="text/css" media="screen">#flashHeader {visibility:hidden}</style></head>
	
	<body class="frontpage" hkid="[object HTMLBodyElement]">
	...
	<script type="text/javascript">
		...
		flashvars.importxmlpath = "<?php echo BASE_PATH;?>/public/templates/<?php echo TEMPLATE; ?>/_content/en-gb/frontpage.xml";
		params.allowScriptAccess = "always"; 			
		var attributes = {};
		swfobject.embedSWF("<?php echo BASE_PATH;?>/public/templates/<?php echo TEMPLATE; ?>/_flash/frontpage/en-gb/banner-cataclysm.swf", "flashHeader", "100%", "500", "9.0.0", false, flashvars, params, attributes);
	</script>
