...
//]]>
	...
	<body class="games-landing" hkid="[object HTMLBodyElement]">
		...
		<div class="content clearfix">
			...
			<div class="left right">			
				...
				<form action="<?php echo BASE_PATH;?>/page/register/" method="post">
					...
					<input class="field" type="text" name="registar" id="signup" value="" size="23" /></label>
					<label class="grey" for="email">Email:<input class="field" type="text" name="email" id="email" size="23" /></label>
					<label class="grey" for="pwd">Password:</label>
					<input class="field" type="password" name="password" id="pwd" size="23" />
					<label class="grey" for="pwd">Confirm Password:</label>
					<input class="field" type="password" name="password2" id="pwd" size="23" />				
