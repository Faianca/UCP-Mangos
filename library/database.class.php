...
class Database
  {
      ...
      function query($sql)
      {
          if (trim($sql != "")) {
              ...
              $this->query_id = mysql_query($sql, $this->connect_db($this->server, $this->user, $this->pass));
      ...
      function insert($table = null, $data)
      {
	   ...
	   function replace($table = null, $data)
      {
		  global $set;
		  if ($table === null or empty($data) or !is_array($data)) {
		  $this->error("Invalid array for table: <b>".$table."</b>.");
	 ...
	 /**
      ...
      function get_under(){
      		$sql = "SELECT underconstruction FROM ".DB_UCP.".settings";
      	        $row = $this->first($sql);
      	        return $row['underconstruction'];
      }
      
      function get_template(){
      	      	$sql = "SELECT template FROM ".DB_UCP.".settings";
      	        $row = $this->first($sql);
      	        return $row['template'];
      }
      ...
      function error($msg = '')
      {
          ...
          $the_error = "<div style=\"background-color:#FFF; border: 3px solid #999; padding:10px; color:#000\">";
